...
无需展开概览，即可直接看到最新首字延迟、最近 3 小时缓存命中率、中转余额和
分组倍率。

<p align="center">
  <img src="docs/images/menu-bar-status-latest.png" alt="Sub2API Menu Bar 菜单栏显示首字延迟、缓存命中率、中转余额和倍率" width="362">
</p>

### v0.2.0 上游账户管理

单一可滚动概览会集中显示当前请求、最近首字延迟、最近 3 小时整体及逐上游缓存
命中率、全部上游账户、调度开关、订阅额度、中转健康状态，以及按需登录第三方
监控的操作。

<p align="center">
  <img src="docs/images/overview-v0.2.0-latest.png" alt="Sub2API Menu Bar v0.2.0 显示缓存命中率和上游账户健康状态" width="386">
</p>
